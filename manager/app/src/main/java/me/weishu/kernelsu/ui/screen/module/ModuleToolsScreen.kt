...
fun ModuleToolsScreen() {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.module_tools_title)) },
                navigationIcon = {
        ...
        Box(
            ...
            Column(
                ...
                ModuleToolRow(
                    ...
                    summary = stringResource(R.string.module_tools_repository_summary),
                    icon = Icons.Rounded.Extension,
                    onClick = dropUnlessResumed { navigator.push(Route.ModuleRepo) },
                )
                ModuleToolRow(
                    title = stringResource(R.string.module_wallpaper_backup_title),
                    summary = stringResource(R.string.module_tools_wallpaper_summary),
                    icon = Icons.Rounded.Backup,
                    onClick = dropUnlessResumed { navigator.push(Route.ModuleWallpaperBackup) },
                )
            }
        }
    }
